...
public class KenkenViewMostraA extends JPanel {
	int size;
	int r,v;
	JButton button;
	Generar g;
	...
	public static void main(String [] args){
	    KenkenViewMostraA kenken = new KenkenViewMostraA(null);
	}
	...
	public KenkenViewMostraA(Generar a) {
